...
public class SurveyController {
    ...
    public List<SurveyDto> getSurveysByProducerIdWithDownloadLink(@PathVariable Long producerId) {
        return surveyService.getSurveysByProducerIdWithDownloadLink(producerId);
    }
}
